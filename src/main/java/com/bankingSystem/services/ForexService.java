...
public class ForexService {
    ...
    public ForexService(UsersService usersService, UsersRepository usersRepository, AccountService accountService, AccountRepository accountRepository){
    ...
    public void exchange(String email, String toCurrency, String fromCurrency, double amount){
